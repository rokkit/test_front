...
function animateMenu() {
  ...
  var tw1 = TweenLite.to(left_part, 0.5, {
    left: '0',
    onComplete: function () {
  ...
  var tw3 = TweenLite.to(color_overlay, 1, {
    opacity: '0.8',
    '-webkit-opacity': '1',
    'pointer-events': 'auto'
  });
  var tw4 = TweenLite.to(main_content, 1, {
    filter: 'blur(5px)',
  ...
  window.tl = new TimelineLite().add([
    tw1,
    tw2,
    tw3,
    tw4,
