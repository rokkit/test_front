...
$(function () {
  ...
  history_open_anim.to('#history_wrapper', 1, {
    top: 0,
    ease: Power4.easeOut
  });
...
$(function () {
  ...
  hm_open_anim.to('#hm_ilya_ponomarev', 1, {
    top: 0,
    ease: Power4.easeOut
  });
...
$(function () {
  ...
  hm_open_anim.from('#hookah_popups', 0.1, { autoAlpha: 0 });
  hm_open_anim.to('#hookah_popups', 0.1, { autoAlpha: 1 });
  hm_open_anim.to('#hm_philipp_boicov', 1, {
    top: 0,
    ease: Power4.easeOut
  });
  hm_open_anim.to('#html_body', 0.1, { overflow: 'hidden' });
...
$(function () {
  ...
  hm_open_anim.from('#hookah_popups', 0.1, { autoAlpha: 0 });
  hm_open_anim.to('#hookah_popups', 0.1, { autoAlpha: 1 });
  hm_open_anim.to('#hm_igor_konovalov', 1, {
    top: 0,
    ease: Power4.easeOut
  });
  hm_open_anim.to('#html_body', 0.1, { overflow: 'hidden' });
...
var cbpAnimatedHeader = function () {
  var docElem = document.documentElement, header = document.getElementById('header'), didScroll = false, changeHeaderOn = 48;
  function init() {
